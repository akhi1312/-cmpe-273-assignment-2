# Pizza Ordering Sytem with AWS
### Abstract

Have build pizza ordering system using AWS Lambda for handling business logic, API Gateway for REST interface, and DynamoDB for data persistence.
